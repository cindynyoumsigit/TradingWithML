...
class InsaneLearner(object):
    """
    This is an InsaneLearner . It is implemented correctly.
    ...
    def __init__(self, verbose = False):
        ...
        for bag in range(0, bags):
            self.learners_list.append(bl.BagLearner(lrl.LinRegLearner,kwargs={},bags=20))
    ...
    def add_evidence(self, data_x, data_y):
        ...
        # index_list = np.linspace(0, data_x.shape[0]-1, data_x.shape[0])
